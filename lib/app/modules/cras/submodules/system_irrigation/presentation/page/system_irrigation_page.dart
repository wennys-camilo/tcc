                            ...
                            children: [
                                ...
                                return Row(
                                  ...
                                  children: [
                                    Flexible(
                                      child: Checkbox(
                                        value: triple
                                                .state.selectedConditionIndex ==
                                            index,
                                        onChanged: (value) {
                                          store
                                              .onChangeSelectedCondition(index);
                                        },
                                      ),
                                    ),
                                    Flexible(
                              ...
                              Padding(
                                ...
                                child: TextInputWidget(
                                  ...
                                  centerText: false,
                                  labelText:
                                      triple.state.selectedConditionIndex == 0
                                    ...
                                    if (value.isNotEmpty) {
                                      store.onChangeSpacingBetweenEmitters(
                                          double.parse(
                                              value.replaceAll(',', '.')));
                                      var nepResult =
                                          (triple.state.plantSpacing /
                                              double.parse(
                                                  value.replaceAll(',', '.')));
                                      nepController.text = nepResult.toString();
                              ...
                              Padding(
                                ...
                                child: TextInputWidget(
                                  ...
                                  onChanged: (value) {
                                    if (value.isNotEmpty) {
                                      store.onChangeEmitterFlow(double.parse(
                                          value.replaceAll(',', '.')));
                                    }
                                  },
                                  validator: (value) {
